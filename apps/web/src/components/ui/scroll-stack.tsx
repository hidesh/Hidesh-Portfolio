...
const skillIcons: Record<string, React.ReactElement> = {
  ...
  'Nuxt.js': <SiNuxt className="text-green-400" />,
  ...
  'AWS': <FaCloud className="text-orange-400" />,
  ...
  'Heroku': <FaCloud className="text-purple-500" />,
  ...
  'OpenAI API': <FaRobot className="text-green-500" />,
